...
YOLO is a great real-time one-stage object detection framework. This repo lists some awesome open-source YOLO series projects.
...
## Applications
  ...
  - ### Lighter and Faster
    ...
    - #### FPGA RISC-V TPU Accelerator Deployment
      #### FPGA RISC-V TPU加速器部署
